...
alias watch-arachne='cd ~/Documents/GitLab/umbrella/apps/arachne && source .env && echo "yarn watch" && yarn watch'
alias build-arachne='cd ~/Documents/GitLab/umbrella/apps/arachne && source .env && echo "yarn build" && yarn build'
